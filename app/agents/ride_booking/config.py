...
class Config:
    ...
    HEADLESS = False  # Set to True to run the browser in the background
    SLOW_MO = 50  # Milliseconds to wait between Playwright actions
    TIMEOUT = 30000  # 30 seconds for Playwright timeouts
