...
from api.instamart_api.instamart_api import router as instamart_router
import uvicorn
...
app.include_router(instamart_router, prefix="/api", tags=["instamart"]) # This already includes the new endpoint
