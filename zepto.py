...
2. Among valid matches, select the most valid product name option and among most valid product name options prefer the cheapest one
...
async def automate_zepto(shopping_list: dict, location: str, mobile_number: str):
    """
...
if __name__ == "__main__":
    async def main():
        user_grocery_query = "hi i need 2 shimla apples 3 oranges 2 amul milks and 3 sugar packets"
        user_location = "Noida Sector 137"
        user_mobile = "7842848429"
        ...
        if shopping_list:
            ...
            print(shopping_list)
            print("----------------------------")
            await automate_zepto(shopping_list, user_location, user_mobile)
        else:
